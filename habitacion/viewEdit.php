    ...
    <html lang="en">
        ...
        <body>
            ...
            <div id="page-wrapper">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Editar Habitaciones</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
                                ...
                                <div class="panel-body">
                                    <div class="dataTable_wrapper">
                                            ...
                                            <form class="form" action="phpedit.php" method="POST">
                                                <label for="id">Identificador de habitacion: </label><br>
                                                <input class="form-group input-group" type="text" name="id" value="<?= Request::get("id"); ?>" readonly/><br>
                                                <label for="descripion">Descripcion: <?= Request::get("descripcion"); ?> </label><br>
                                                <?php echo Util::getSelect("descripcion", $parametros); ?><br>
                                                <input class="btn btn-success" type="submit" value="Editar Habitacion" />
                                            </form>
                                    </div>
                                    <!-- /.table-responsive -->

...
$op = null;
$habitaciones = $gestor->getList($paginacion->getPaginaActual(), $order, $paginacion->getRpp(), $condicion, $parametros);
?>
<!DOCTYPE html>
<html lang="en">
                                        ...
                                        <table class="table table-striped table-bordered table-hover">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <td>
                                                        DESCRIPCION
                                                        <a href="?order=descripcion&sort=asc">▲</a>
                                                        <a href="?order=descripcion&sort=desc">▼</a>
                                                    </td>
                                            ...
                                            <tbody>
                                                <?php foreach ($habitaciones as $indice => $habitacion) { ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a class="borrar" href="phpdelete.php?id=<?php echo $habitacion->getId(); ?>&page=<?php echo Request::get("page") ?>">Borrar</a>
                                                        </td>

                                                        <td>
                                                            <a href="viewEdit.php?id=<?php echo $habitacion->getId(); ?>&descripcion=<?php echo $habitacion->getDescripcion(); ?>&page=<?php echo Request::get("page") ?>">Editar</a><br>
                                                        </td>
                                                    </tr>
                                                <?php } $bd->close(); ?>
                                            </tbody>

                        ...
                        <ul class="nav" id="side-menu">
                            <li>
                                ...
                                <ul class="nav nav-second-level">
                                    ...
                                    <li>
                                        <a class="links" href="usuario.php">Volver a usuarios</a>
                                    </li>
                                </ul>
                                <!-- /.nav-third-level -->
                            </li>
                                ...
                                <div class="panel-body">
                                    <div class="dataTable_wrapper">
                                        ...
                                        <form action="phpedit.php" method="POST">
                                            <input class="form-group input-group" type="text" name="nombre" value="<?php echo $usuario->getNombre(); ?>" />
                                            <input class="form-group input-group" type="text" name="apellidos" value="<?php echo $usuario->getApellidos(); ?>" />
                                             <label for="idhabitacion">Habitacion: </label>
                                            <?php echo Util::getSelect("idhabitacion", $gestorHabitacion->getValuesSelect()); ?><br>
                                            <input class="form-group input-group" type="hidden" name="pkdni" value="<?php echo $dni; ?>" />

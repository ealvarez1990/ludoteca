                                ...
                                <div class="panel-body">
                                    <div class="dataTable_wrapper">
                                        ...
                                        <form class="form" action="phpalta.php" method="POST">
                                            <input class="form-group input-group" type="text" name="dni" value="" placeholder="DNI"/><br>
                                            <input class="form-group input-group" type="text" name="nombre" value="" placeholder="Nombre"/><br>
                                            <input class="form-group input-group" type="text" name="apellidos" value="" placeholder="Apellidos"/><br>
